...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    invoke-static {p1}, Lcom/android/launcher3/Launcher;->u3(Landroid/content/Context;)Lcom/android/launcher3/Launcher;
    ...
    .line 8
    sget-object v0, Lcom/android/launcher3/n7;->c:[Ljava/lang/String;

    .line 9
    sget-boolean v0, Ll/g/y/h/g;->a:Z
...
.method private b(Lcom/android/launcher3/DragLayer;)V
    ...
    invoke-virtual {p1}, Lcom/android/launcher3/Launcher;->H0()Lcom/android/launcher3/util/p1;

    move-result-object p1

    const v0, 0x7f0d00d4

    invoke-virtual {p1, v0, p0}, Lcom/android/launcher3/util/p1;->b(ILandroid/view/View;)V

    return-void
.end method

.method public static c(Lcom/android/launcher3/Launcher;Landroid/view/View;ZLandroid/graphics/RectF;Z)Lcom/android/launcher3/views/FloatingIconView;
    .locals 18
    ...
    .line 1
    sget-object v10, Lcom/android/launcher3/views/FloatingIconView;->v:Ljava/lang/String;

    invoke-virtual/range {p0 .. p0}, Lcom/android/launcher3/Launcher;->j3()Lcom/android/launcher3/DragLayer;
    ...
    .line 3
    invoke-virtual/range {p0 .. p0}, Lcom/android/launcher3/Launcher;->H0()Lcom/android/launcher3/util/p1;

    move-result-object v1

    const v2, 0x7f0d00d4

    invoke-virtual {v1, v2, v0, v12}, Lcom/android/launcher3/util/p1;->a(ILandroid/content/Context;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v1

    move-object v13, v1

    check-cast v13, Lcom/android/launcher3/views/FloatingIconView;

    .line 4
    invoke-direct {v13}, Lcom/android/launcher3/views/FloatingIconView;->j()V
    ...
    instance-of v1, v1, Lcom/android/launcher3/b5;
    ...
    iget-object v1, v1, Lcom/android/launcher3/views/FloatingIconView$a;->a:Lcom/android/launcher3/b5;
    ...
    iput-object v1, v13, Lcom/android/launcher3/views/FloatingIconView;->f:Lcom/android/launcher3/views/FloatingIconView$a;
    ...
    check-cast v4, Lcom/android/launcher3/b5;

    .line 9
    new-instance v15, Lcom/android/launcher3/views/FloatingIconView$a;

    invoke-direct {v15, v4, v2}, Lcom/android/launcher3/views/FloatingIconView$a;-><init>(Lcom/android/launcher3/b5;Z)V
    ...
    .line 11
    invoke-static {v0, v7, v9, v5}, Lcom/android/launcher3/views/FloatingIconView;->d(Lcom/android/launcher3/Launcher;Landroid/view/View;ZLandroid/graphics/RectF;)V

    .line 12
    sget-object v1, Lcom/android/launcher3/util/d0;->g:Lcom/android/launcher3/util/m0;

    invoke-virtual {v1}, Lcom/android/launcher3/util/m0;->a()Landroid/os/Handler;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/launcher3/views/f;-><init>(Lcom/android/launcher3/Launcher;Landroid/view/View;Lcom/android/launcher3/b5;Landroid/graphics/RectF;Lcom/android/launcher3/views/FloatingIconView$a;)V

    invoke-virtual {v14, v10}, Landroid/os/Handler;->postAtFrontOfQueue(Ljava/lang/Runnable;)Z

    .line 13
    sput-object v15, Lcom/android/launcher3/views/FloatingIconView;->w:Lcom/android/launcher3/views/FloatingIconView$a;

    .line 14
    iput-object v15, v13, Lcom/android/launcher3/views/FloatingIconView;->f:Lcom/android/launcher3/views/FloatingIconView$a;
    ...
    .line 16
    invoke-virtual/range {p0 .. p0}, Lcom/android/launcher3/Launcher;->F0()Lcom/android/launcher3/k4;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/launcher3/k4;->u()Z

    move-result v1

    iput-boolean v1, v13, Lcom/android/launcher3/views/FloatingIconView;->d:Z

    .line 17
    iput-boolean v9, v13, Lcom/android/launcher3/views/FloatingIconView;->e:Z

    .line 18
    iput-object v7, v13, Lcom/android/launcher3/views/FloatingIconView;->i:Landroid/view/View;

    .line 19
    iput-object v8, v13, Lcom/android/launcher3/views/FloatingIconView;->j:Landroid/graphics/RectF;

    .line 20
    invoke-static {v0, v7, v9, v8}, Lcom/android/launcher3/views/FloatingIconView;->d(Lcom/android/launcher3/Launcher;Landroid/view/View;ZLandroid/graphics/RectF;)V
    ...
    .line 24
    invoke-direct {v13, v8, v0}, Lcom/android/launcher3/views/FloatingIconView;->m(Landroid/graphics/RectF;Lcom/android/launcher3/InsettableFrameLayout$LayoutParams;)V

    .line 25
    invoke-virtual {v13, v0}, Landroid/widget/FrameLayout;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 26
    iget-object v1, v13, Lcom/android/launcher3/views/FloatingIconView;->g:Lcom/android/launcher3/views/ClipIconView;
    ...
    .line 29
    iget-object v0, v13, Lcom/android/launcher3/views/FloatingIconView;->t:Lcom/android/launcher3/views/ListenerView;
    ...
    invoke-direct {v1, v13}, Lcom/android/launcher3/views/k;-><init>(Lcom/android/launcher3/views/FloatingIconView;)V

    invoke-virtual {v0, v1}, Lcom/android/launcher3/views/ListenerView;->setListener(Ljava/lang/Runnable;)V

    .line 31
    new-instance v8, Lcom/android/launcher3/views/e;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/launcher3/views/e;-><init>(Lcom/android/launcher3/views/FloatingIconView;ZZLandroid/view/View;Lcom/android/launcher3/DragLayer;)V

    iput-object v8, v13, Lcom/android/launcher3/views/FloatingIconView;->a:Ljava/lang/Runnable;

    if-eqz v17, :cond_6

    .line 32
    iget-object v1, v13, Lcom/android/launcher3/views/FloatingIconView;->f:Lcom/android/launcher3/views/FloatingIconView$a;
    ...
    .line 34
    :try_start_0
    iget-object v0, v13, Lcom/android/launcher3/views/FloatingIconView;->f:Lcom/android/launcher3/views/FloatingIconView$a;

    iget-boolean v2, v0, Lcom/android/launcher3/views/FloatingIconView$a;->e:Z
    :try_end_0
    ...
    const-string v4, "  getFloatingIconView() mIconLoadResult notifyAll e1->"
    ...
    const-string v4, "  getFloatingIconView() view.mIconLoadResult e->"
    ...
    invoke-static {v0}, Lcom/transsion/launcher/q;->d(Ljava/lang/String;)V
    :try_end_4
    ...
    const-string v3, "  getFloatingIconView() mIconLoadResult notifyAll e1->"
    ...
    .line 46
    iget-object v2, v13, Lcom/android/launcher3/views/FloatingIconView;->f:Lcom/android/launcher3/views/FloatingIconView$a;
    ...
    iget-boolean v3, v1, Lcom/android/launcher3/views/FloatingIconView$a;->e:Z

    if-eqz v3, :cond_5

    .line 50
    iget-object v0, v1, Lcom/android/launcher3/views/FloatingIconView$a;->b:Landroid/graphics/drawable/Drawable;

    iget v1, v1, Lcom/android/launcher3/views/FloatingIconView$a;->c:I

    invoke-direct {v13, v0, v6, v1}, Lcom/android/launcher3/views/FloatingIconView;->k(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;I)V

    .line 51
    invoke-direct {v13, v7}, Lcom/android/launcher3/views/FloatingIconView;->e(Landroid/view/View;)V
    ...
    invoke-direct {v3, v13, v0, v7}, Lcom/android/launcher3/views/g;-><init>(Lcom/android/launcher3/views/FloatingIconView;Landroid/os/CancellationSignal;Landroid/view/View;)V

    iput-object v3, v1, Lcom/android/launcher3/views/FloatingIconView$a;->d:Ljava/lang/Runnable;

    .line 53
    iput-object v0, v13, Lcom/android/launcher3/views/FloatingIconView;->b:Landroid/os/CancellationSignal;
...
.method private static d(Lcom/android/launcher3/Launcher;Landroid/view/View;ZLandroid/graphics/RectF;)V
    .locals 6
    ...
    invoke-virtual {v3, v1}, Lcom/android/launcher3/BubbleTextView;->t(Landroid/graphics/Rect;)V
    ...
    .line 11
    invoke-virtual {v3, v4}, Lcom/transsion/xlauncher/folder/FolderIcon;->J(Landroid/graphics/Rect;)V
    ...
    .line 15
    invoke-virtual {p0}, Lcom/android/launcher3/Launcher;->j3()Lcom/android/launcher3/DragLayer;

    move-result-object p0

    invoke-static {p1, p0, v3, v2, p2}, Lcom/android/launcher3/n7;->F(Landroid/view/View;Landroid/view/View;[FZZ)F
...
.method private e(Landroid/view/View;)V
    ...
    .line 7
    invoke-virtual {p1, v1}, Lcom/transsion/xlauncher/folder/FolderIcon;->g0(Z)V
...
.method static h(Lcom/android/launcher3/Launcher;Landroid/view/View;Lcom/android/launcher3/b5;Landroid/graphics/RectF;Lcom/android/launcher3/views/FloatingIconView$a;)V
    .locals 5
    ...
    invoke-virtual {v2}, Lcom/android/launcher3/FastBitmapDrawable;->e()Landroid/graphics/Bitmap;
    ...
    .line 7
    :cond_0
    instance-of v1, p1, Lcom/transsion/xlauncher/folder/FolderIcon;
    ...
    .line 10
    invoke-virtual {v1, v2}, Lcom/transsion/xlauncher/folder/FolderIcon;->J(Landroid/graphics/Rect;)V
    ...
    .line 14
    invoke-static {v1, v3, v4}, Lcom/android/launcher3/n7;->i(Landroid/view/View;II)Landroid/graphics/Bitmap;
    ...
    .line 17
    instance-of p1, p1, Lcom/transsion/xlauncher/folder/FolderIcon;
    ...
    instance-of p1, v1, Landroid/graphics/drawable/AdaptiveIconDrawable;
    ...
    invoke-direct {v2, p2, p2, v3, p3}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    .line 25
    invoke-virtual {v2, p1, p2}, Landroid/graphics/Rect;->inset(II)V
    ...
    .line 28
    :try_start_0
    iput-object v1, p4, Lcom/android/launcher3/views/FloatingIconView$a;->b:Landroid/graphics/drawable/Drawable;

    .line 29
    iput p2, p4, Lcom/android/launcher3/views/FloatingIconView$a;->c:I

    .line 30
    iget-object p1, p4, Lcom/android/launcher3/views/FloatingIconView$a;->d:Ljava/lang/Runnable;
    ...
    .line 32
    iput-object v0, p4, Lcom/android/launcher3/views/FloatingIconView$a;->d:Ljava/lang/Runnable;

    :cond_7
    const/4 p0, 0x1

    .line 33
    iput-boolean p0, p4, Lcom/android/launcher3/views/FloatingIconView$a;->e:Z
    :try_end_0
    ...
    const-string p2, "  getIconResult() mIconLoadResult notifyAll e->"
    ...
    invoke-static {p0}, Lcom/transsion/launcher/q;->d(Ljava/lang/String;)V
...
.method static i(Lcom/android/launcher3/views/FloatingIconView;ZZLandroid/view/View;Lcom/android/launcher3/DragLayer;)V
    ...
    .line 8
    invoke-virtual {p3, v0}, Lcom/transsion/xlauncher/folder/FolderIcon;->g0(Z)V
    ...
    .line 13
    new-instance v1, Lcom/android/launcher3/views/o;

    invoke-direct {v1, p0, p3, p4}, Lcom/android/launcher3/views/o;-><init>(Lcom/android/launcher3/views/FloatingIconView;Landroid/view/View;Lcom/android/launcher3/DragLayer;)V
...
.method private j()V
    ...
    .line 13
    :cond_1
    iput-object v0, p0, Lcom/android/launcher3/views/FloatingIconView;->j:Landroid/graphics/RectF;
    ...
    .line 16
    iput-object v0, p0, Lcom/android/launcher3/views/FloatingIconView;->i:Landroid/view/View;

    .line 17
    iput-object v0, p0, Lcom/android/launcher3/views/FloatingIconView;->k:Ljava/lang/Runnable;
...
.method private k(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-virtual {p1}, Lcom/android/launcher3/Launcher;->F0()Lcom/android/launcher3/k4;

    move-result-object p1

    iget p1, p1, Lcom/android/launcher3/k4;->f:F
...
.method private m(Landroid/graphics/RectF;Lcom/android/launcher3/InsettableFrameLayout$LayoutParams;)V
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/android/launcher3/views/FloatingIconView;->j:Landroid/graphics/RectF;
...
.method public synthetic g(Landroid/os/CancellationSignal;Landroid/view/View;)V
    .locals 2
    ...
    .line 2
    :cond_0
    invoke-static {p2}, Lcom/transsion/xlauncher/folder/m0;->l(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Lcom/transsion/launcher/q;->a(Ljava/lang/String;)V
    ...
    .line 6
    invoke-direct {p0, p2}, Lcom/android/launcher3/views/FloatingIconView;->e(Landroid/view/View;)V

    :goto_0
    return-void
.end method

.method public l(Landroid/graphics/RectF;FFFFZ)F
    .locals 15
    ...
    invoke-virtual {v1}, Lcom/android/launcher3/Launcher;->F0()Lcom/android/launcher3/k4;
    ...
    invoke-static {v2}, Ll/g/y/q/f/n;->D(F)F
...
.method public onAnimationStart(Landroid/animation/Animator;)V
    ...
    .line 4
    iget-object p1, p0, Lcom/android/launcher3/views/FloatingIconView;->i:Landroid/view/View;

    invoke-direct {p0, p1}, Lcom/android/launcher3/views/FloatingIconView;->e(Landroid/view/View;)V
...
.method public onGlobalLayout()V
    ...
    .line 1
    iget-object v0, p0, Lcom/android/launcher3/views/FloatingIconView;->i:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/android/launcher3/views/FloatingIconView;->i:Landroid/view/View;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/android/launcher3/views/FloatingIconView;->d(Lcom/android/launcher3/Launcher;Landroid/view/View;ZLandroid/graphics/RectF;)V
    ...
    invoke-direct {p0, v3, v0}, Lcom/android/launcher3/views/FloatingIconView;->m(Landroid/graphics/RectF;Lcom/android/launcher3/InsettableFrameLayout$LayoutParams;)V

    .line 5
    iget-object v0, p0, Lcom/android/launcher3/views/FloatingIconView;->k:Ljava/lang/Runnable;
...
.method public setOnTargetChangeListener(Ljava/lang/Runnable;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/android/launcher3/views/FloatingIconView;->k:Ljava/lang/Runnable;
